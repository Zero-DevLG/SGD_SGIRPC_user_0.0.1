...
-->
    ...
    <script src="../js/tables_dir.js"></script>
        ...
        <div id="iframeI" style="overflow-y: auto;">
            ...
            <div id="contenido">
                <ul class='nav nav-tabs' id="tabs_documentos">
                    ...
                    <li><a data-toggle="tab" id="loadGen" href="#menu_r">Documentos recibidos</a></li>
                    <li><a data-toggle="tab" id="loadAss" href="#menu_a">Documentos atendidos</a></li>
                    <li><a data-toggle="tab" id="loadEs" href="#menu_t">Documentos turnados</a></li>
                ...
                <div class="tab-content">
                    ...
                    <div id="menu_r" class="tab-pane fade in">
                        <ul class='nav nav-tabs' id="tabs_documentos2">
                                <li><a data-toggle="tab" id="loadAreasRes" href="#menu_aR">Documentos direccion</a></li>
                                <li><a data-toggle="tab" id="loadTitularRes" href="#menu_tR">En representacion...</a></li>
                        </ul>

                        <div class="tab-content">
                            <div id="menu_aR" class="tab-pane fade in active">
                                   <div id="secc_ares">
                                   <table id="doc_dir" style="cursor:pointer;"
                            ...
                            <div id="menu_tR" class="tab-pane fade in">
                                   <div id="secc_tres">
                                       <h1>Documentos en representacion de </h1>
                                   </div>
                    ...
                    <div id="menu_as" class="tab-pane fade">
                        <ul class='nav nav-tabs' id="tabs_documentos3">
                            <li><a data-toggle="tab" id="loadtt" href="#menu_ti">Turnos titular</a>
                            </li>
