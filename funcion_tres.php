...
$consulta = $pdo->prepare("SELECT d.id_documento,d.folio,op.num,res.folio_res,res.date_res,di.asunto FROM documentos_externos AS d INNER JOIN documento_instruccion AS di ON d.id_documento = di.id_documento INNER JOIN op_control_t AS op ON op.id_documento = d.id_documento INNER JOIN tem_res AS res ON res.id_documento = d.id_documento ");
$consulta->execute();
