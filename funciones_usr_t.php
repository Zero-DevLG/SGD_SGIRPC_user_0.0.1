...
$consulta = $pdo->prepare("SELECT de.id_documento,opt.num,de.folio,de.fecha_registro FROM documentos_externos as de INNER JOIN  op_control_t as opt ON opt.id_documento = de.id_documento WHERE de.id_empleado_r = '$id_usr'");
$consulta->execute();
