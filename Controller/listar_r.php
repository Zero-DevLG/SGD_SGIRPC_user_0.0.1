...
$query = $con->prepare("SELECT d.id_documento,d.fecha_registro,d.n_folio,d.asunto,e.descripcion FROM documentos as d INNER JOIN documento_ciclo as dc ON d.id_documento = dc.id_documento INNER JOIN estado as e ON e.id_estado = dc.estado WHERE dc.origen='" . $dir_local . "' LIMIT ? OFFSET ?");
