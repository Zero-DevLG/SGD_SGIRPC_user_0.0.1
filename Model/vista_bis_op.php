...
$consulta_doc_ext = $pdo->prepare("SELECT de.id_documento,de.folio,op.num FROM documentos_externos as de INNER JOIN op_control as op ON de.id_documento = op.id_documento WHERE de.id_documento='$id_documento'");
...
function mostrarDatos() {
    ...
    $.ajax({
        type: "POST",
        url: "../Controller/show_data_bis_op.php",
        data: {
            'op_control': num
        },
        success: function(r) {
