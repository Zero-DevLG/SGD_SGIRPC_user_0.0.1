...
<div id="resize">
    ...
    <?php }else { ?>
        ...
        <a href="../pdf2.php" target="blank"><img src="../img/iconos/pdf.png" id="gen_pdf" title="Generar volante"
                alt=""></a>
        <!-- <a href="#"><img id="submit_d" src="../img/iconos/enviar_d.png" title="Enviar a direccion"></a> -->
        <a href="#"><img id="reply_doc" src="../img/iconos/reply_doc.png" title="Agregar respuesta"></a>
...
<div id="modal_reply" class="modal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      <img id="logo" src="../img/iconos/logo_2022.jpg">
