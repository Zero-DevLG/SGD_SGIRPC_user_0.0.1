...
<body>
    ...
    <div id="form_bis">
        ...
        <div class="form-row">
            ...
            <div class="col-md-6">
            <label>Categoria de oficialia:</label>
            <select class="form-control" id="cat_of">
                <option value="20">Titular</option>
                <option value="200">Areas</option>
            </select>
            </div>
        </div>
            <div class="form-row">
...
function mostrarDatos() {
    ...
    $.ajax({
        type: "POST",
        url: "../Controller/show_data_bis.php",
        data: {
            'folio_o': folio_o
        },
        success: function(r) {
...
$('#reg_doc').click(function() {
    ...
    let bis = 1;
    let bis_cat = 3;
    let op_control = $('#no_control').val();
    let cat_of = $('#cat_of').val();
    ...
    form_data.append('cat_of'cat_of);
