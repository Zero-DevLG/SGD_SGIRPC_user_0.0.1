...
$consulta_doc_ex = $pdo->prepare("SELECT de.id_documento,sp.detalle,op.num FROM documentos_externos as de INNER JOIN control_sp as sp ON sp.id_direccion = de.id_direccion INNER JOIN op_control as op ON op.id_documento = de.id_documento ");
