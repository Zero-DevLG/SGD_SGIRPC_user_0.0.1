...
<body background="../img/fondo_hoja2.jpg">
    ...
    <div id="subnav_r">
        <a href="#" id="myBtn6"><img id="ver_res" src="../img/iconos/respuesta.png" title="Responder documento"></a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul class='nav nav-tabs'>
                        ...
                        <li><a data-toggle="tab" href="#menu_datos">Datos</a></li>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <center>
                                            ...
                                            <input type="text" name="fol_id_doc" id="folio"
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="txtdestinatario"
                                            name="txtdestinatario" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label>Cargo destinatario</label>
                                        <input type="text" class="form-control" id="txtcargod" name="txtcargodes"
                                            required>
                                    </div>
                                </div>
                                <div class="form-row">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul class='nav nav-tabs'>
                        ...
                        <li><a data-toggle="tab" href="#menu5">Turnar documento</a></li>
                    </ul>
                    <div class="tab-content">
                        <div id="home" class="tab-pane fade in active">
                            <h1>Selecciona una opcion</h1>
