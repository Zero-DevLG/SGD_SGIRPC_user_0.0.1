...
if (isset($consultaBusqueda)) {
    $consulta = $pdo->prepare("SELECT * FROM documentos WHERE id_documento = '$consultaBusqueda'");
    $consulta->execute();
    ...
    if ($filas === 0) {
        ...
        foreach ($datos as $mostrar) {
            ...
            $tipo_documento = $mostrar['tipo_documento'];
            $asunto = $mostrar['asunto'];
            $destinatario = $mostrar['destinatario'];
            $cargo_d = $mostrar['cargo_d'];
            $anotaciones = $mostrar['anotaciones'];
...
<head>
    ...
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
            ...
            <div id="cabezera">
                ...
                <tr>
                <td id="title"><h4 id="folio">Folio:</h4></td>
                <td id="content"><h5 id="folio_1">' . $folio . '<span></span></h5></td>
                </tr>
                <tr>
                <td id="title"><h4 id="remitente">Remitente:</h4></td>
                <td id="content"><h5 id="remitente_1">' . $remitente . '<span></span></h5></td>
                </tr>
                <tr>
                <td id="title"><h4 id="cargo">Cargo:</h4></td>
                <td id="content"><h5 id="cargo_1">' . $cargo_r . '<span></span></h5></td>
                </tr>
            <tr>
            <td id="title"><h4 id="asunto">Asunto:</h4></td>
            <td id="content"><h5>' . $asunto . '<span></span></h5></td>
            </tr>
            <tr>
            <td id="title"><h4 id="destino">Para:</h4></td>
            <td id="content"><h5 id="destino1">' . $destinatario . '<span></span></h5></td>
            </tr>
            <tr>
            <td id="title"><h4 id="cargo_d">Cargo:</h4></td>
            <td id="content"><h5 id="cargo_d1">' . $cargo_d . '<span></span></h5></td>
            </tr>
            <tr>
            <td id="title"><h4 id="ant">Anotaciones:</h4></td>
            <td id="content"><h5 id="ant1">' . $anotaciones . '<span></span></h5></td>
            </tr>

            </table>
        
            <div id="subnav">
            <a href="#" id="myBtn5"><img id="ver_ins" src="../img/iconos/ver_instruccion.png" title="Ver instrucciones asignadas"></a>
            <a href="#" id="myBtn6"><img id="ver_res" src="../img/iconos/respuesta.png" title="Ver respuesta del documento"></a>
            <a href="#" id="myBtn4"><img id="resp2" src="../img/iconos/enviar-m.png" title="Asignar instrucciones multiples"></a>
