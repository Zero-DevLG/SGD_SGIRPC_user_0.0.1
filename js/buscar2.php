    ...
    <div class="modal fade" id="myModal" role="document">
        <div class="modal-dialog modal-lg modal-sm">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="modal_ins">
                    <ul class='nav nav-tabs'>
                        <li class='active'><a data-toggle="tab" href="#home2">Instrucciones</a></li>
                        <li><a data-toggle="tab" href="#menu12">Subir archivos</a></li>
                        <li><a data-toggle="tab" href="#menu15">Ver archivos</a></li>
                    </ul>
