var url_listar_usuario2 = "../Controller/listar_r.php";
...
$(document).ready(function () {
  ...
  paginador = $(".pagination2");
  // cantidad de items por pagina
  var items = 25,
    numeros = 4;
  // inicia el paginador
  init_paginator2(paginador, items, numeros);
  // se envia la peticion ajax que se realizara como callback
  set_callback2(get_data_callback);
  cargaPagina2(0);
});
